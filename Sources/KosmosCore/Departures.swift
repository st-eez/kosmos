...
/// of their own (docs/tree.md). The inventory looks at it as soon as no read of window rows
/// is under way (Looks), when a native tab switch has paired.
