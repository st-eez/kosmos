...
@Suite struct DisplayParseTests {
    @Test func parsesTheMonitorCommands() {
        let cases: [([String], Command)] = [
            ...
            (["focus", "--ignore-floating", "--boundaries", "all-monitors-outer-frame", "down"],
             .focus(.down, boundaries: .allMonitors, ignoreFloating: true)),
            (["focus", "left", "--ignore-floating"], .focus(.left, ignoreFloating: true)),
