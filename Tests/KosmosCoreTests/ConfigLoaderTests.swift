...
@Suite struct ConfigLoaderTests {
    ...
    @Test func borders() throws {
        ...
        #expect(try #require(load("").config).borders == BorderSettings(width: 2, active: nil, inactive: .clear))
        ...
        #expect(table.borders == BorderSettings(width: 3, active: nil, inactive: BorderColor(hex: "#414868")!))
